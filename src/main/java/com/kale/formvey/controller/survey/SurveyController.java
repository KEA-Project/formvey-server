...
public class SurveyController {
     ...
     */
    @ResponseBody
    @PutMapping("/create/{status}/{surveyId}")
    private BaseResponse<PostSurveyRes> updateSurvey(@RequestBody PostSurveyReq dto, @PathVariable int status, @PathVariable Long surveyId) {
        Long memberId = jwtService.getUserIdx();
